    ...
    for (let row = 0; row < mine.height; row++) {
      ...
      for (let col = 0; col < mine.width; col++) {
        ...
        if (!mine.board[row][col].m) {
          ...
          if (lastRow != -1) {
            if (lastCol != -1) {
              if (mine.board[lastRow][lastCol].m) {
                mine.board[row][col].a++;
              }
            }
            if (mine.board[lastRow][col].m) {
              mine.board[row][col].a++;
            }
            if (nextCol != -1) {
              if (mine.board[lastRow][nextCol].m) {
                mine.board[row][col].a++;
              }
            }
          }
          ...
          if (lastCol != -1) {
            if (mine.board[row][lastCol].m) {
              mine.board[row][col].a++;
            }
          }
          if (nextCol != -1) {
            if (mine.board[row][nextCol].m) {
              mine.board[row][col].a++;
            }
          }
          ...
          if (nextRow != -1) {
            if (lastCol != -1) {
              if (mine.board[nextRow][lastCol].m) {
                mine.board[row][col].a++;
              }
            }
            if (mine.board[nextRow][col].m) {
              mine.board[row][col].a++;
            }
            if (nextCol != -1) {
              if (mine.board[nextRow][nextCol].m) {
                mine.board[row][col].a++;
              }
            }
          }
  ...
  open: (cell) => {
    ...
    // (D3) REVEAL SELECTED CELL + ALL EMPTY ADJACENT CELLS
      ...
      while (toCheck.length > 0) {
        ...
        if (
          mine.board[thisRow][thisCol].m ||
          mine.board[thisRow][thisCol].r ||
          mine.board[thisRow][thisCol].x
        ) {
        } else {
          // ADD CELL TO REVEAL
          if (!checked[thisRow][thisCol]) {
            toReveal.push([thisRow, thisCol]);
          }
          ...
          if (mine.board[thisRow][thisCol].a == 0) {
            ...
            if (lastRow != -1) {
              ...
              if (!checked[lastRow][thisCol]) {
                toCheck.push([lastRow, thisCol]);
              }
            ...
            // CURRENT ROW
            if (lastCol != -1 && !checked[thisRow][lastCol]) {
              toCheck.push([thisRow, lastCol]);
            }
            if (nextCol != -1 && !checked[thisRow][nextCol]) {
              toCheck.push([thisRow, nextCol]);
            }
            ...
            if (nextRow != -1) {
              ...
              if (!checked[nextRow][thisCol]) {
                toCheck.push([nextRow, thisCol]);
              }
...
var a = document.querySelector(".lasennerdesin");
console.log(a);
